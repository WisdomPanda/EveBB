...
if ($action == 'check_upgrade') {
	...
	if (version_compare(EVE_BB_VERSION, $latest_version, '>=')) {
		...
		message(sprintf($lang_admin_index['New version available message'], '<a href="http://eve-bb.com/">EvE-BB.com</a>'));
	} //End if - else.
} //End if.
		...
		<div id="adstats" class="box">
			<div class="inbox">
				<dl>
					...
					<dd>
						<?php printf($lang_admin_index['FluxBB version data'], EVE_BB_VERSION, '<a href="admin_index.php?action=check_upgrade">'.$lang_admin_index['Check for upgrade'].'</a>') ?>
					</dd>
