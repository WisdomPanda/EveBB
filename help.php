...
<div class="box">
	<div class="inbox">
		...
		<p><code>[h]<?php echo $lang_help['Heading text'] ?>[/h]</code> <?php echo $lang_help['produces'] ?></p> <div class="postmsg"><h5><?php echo $lang_help['Heading text'] ?></h5>
		<p><code>[size=24]<?php echo $lang_help['Size text'] ?>[/size]</code> <?php echo $lang_help['produces'] ?> <span style="font-size: 24px;"><?php echo $lang_help['Size text'] ?></span></p>
		</div>
	</div>
</div>
...
<div class="box">
	...
	<div class="inbox">
		...
		<p><code>[img=EveBB bbcode test]<?php echo $pun_config['o_base_url'].'/' ?>img/test.png[/img]</code> <?php echo $lang_help['produces'] ?> <samp><img src="<?php echo $pun_config['o_base_url'].'/' ?>img/test.png" alt="EveBB bbcode test" /></samp></p>
	</div>
</div>
