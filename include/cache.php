...
function generate_quickjump_cache($group_id = false)
{
	...
	foreach ($groups as $group_id)
	{
		...
		$fh = fopen(
		FORUM_CACHE_DIR.
		'cache_quickjump_'.$group_id.'.php', 'wb');
		if (!$fh)
			error('Unable to write quick jump cache file to cache directory. Please make sure PHP has write access to the directory \'cache\' ('.FORUM_CACHE_DIR.'cache_quickjump_'.$group_id.'.php)', __FILE__, __LINE__);
