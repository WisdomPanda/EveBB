...
<?php if ($is_admin): ?>					<li<?php if ($page == 'eve_online') echo ' class="isactive"'; ?>><a href="admin_eve_online.php"><?php echo $lang_admin_common['Eve Online'] ?></a></li>
<?php endif; ?>
<?php if ($is_admin && defined('EVE_ALLIANCE_ENABLED')): ?>					<li<?php if ($page == 'eve_ally') echo ' class="isactive"'; ?>><a href="admin_eve_alliance.php"><?php echo $lang_admin_common['Eve Alliance'] ?></a></li>
<?php endif; ?>
<?php if ($is_admin): ?>					<li<?php if ($page == 'eve_corp') echo ' class="isactive"'; ?>><a href="admin_eve_corps.php"><?php echo $lang_admin_common['Eve Corporation'] ?></a></li>
<?php endif; ?>
<?php if ($is_admin): ?>					<li<?php if ($page == 'eve_groups') echo ' class="isactive"'; ?>><a href="admin_eve_groups.php"><?php echo $lang_admin_common['Eve Groups'] ?></a></li>
<?php endif; ?>
