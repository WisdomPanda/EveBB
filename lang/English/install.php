...
'Install message'				=>	'The file \'config.php\' doesn\'t exist or is corrupt. This implies that EveBB has not yet been installed.',
...
'My FluxBB Forum'				=>	'My EveBB Forum',
...
'No DB extensions'				=>	'This PHP environment does not have support for any of the databases that EveBB supports. PHP needs to have support for either MySQL, PostgreSQL or SQLite in order for EveBB to be installed.',
...
'FluxBB Installation'			=>	'EveBB Installation',
'Welcome'						=>	'You are about to install EveBB. In order to install EveBB, you must complete the form set out below. If you encounter any difficulties with the installation, please refer to the documentation.',
'Install'						=>	'Install EveBB 1.1.0',
'Errors'						=>	'The following errors need to be corrected:',
'Database setup'				=>	'Database setup',
'Info 1'						=>	'Please enter the requested information in order to setup your database for EveBB. You must know all the information asked for before proceeding with the installation.',
'Select database'				=>	'Select your database type',
'Info 2'						=>	'EveBB currently supports MySQL, PostgreSQL and SQLite. If your database of choice is missing from the drop-down menu below, it means this PHP environment does not have support for that particular database. More information regarding support for particular versions of each database can be found in the FAQ.',
'Dual MySQL'					=>	'EveBB has detected that your PHP environment supports two different ways of communicating with MySQL. The two options are called standard and improved. If you are uncertain which one to use, start by trying improved and if that fails, try standard.',
'InnoDB'						=>	'EveBB has detected that your MySQL server might support <a href="http://dev.mysql.com/doc/refman/5.0/en/innodb.html">InnoDB</a>. This would be a good choice if you are planning to run a large forum. If you are uncertain, it is recommended that you do not use InnoDB.',
...
'Info 6'						=>	'If you like, you can specify a table prefix. This way you can run multiple copies of EveBB in the same database (example: foo_).',
'Table prefix'					=>	'Table prefix',
'Administration setup'			=>	'Administration setup',
'Info 7'						=>	'Please enter the requested information in order to setup an administrator for your EveBB installation.',
...
'Info 11'						=>	'Please enter the requested information in order to setup your EveBB board.',
...
'Enter base URL'				=>	'Enter the Base URL of your EveBB installation',
'Info 14'						=>	'The URL (without trailing slash) of your EveBB forum (example: http://forum.myhost.com or http://myhost.com/~myuser). This <strong>must</strong> be correct, otherwise, administrators and moderators will not be able to submit any forms. Please note that the preset value below is just an educated guess by EveBB.',
...
'Existing table error'			=>	'A table called \'%susers\' is already present in the database \'%s\'. This could mean that EveBB is already installed or that another piece of software is installed and is occupying one or more of the table names EveBB requires. If you want to install multiple copies of EveBB in the same database, you must choose a different table prefix',
...
'Alert cache'					=>	'<strong>The cache directory is currently not writable!</strong> In order for EveBB to function properly, the directory <em>%s</em> must be writable by PHP. Use chmod to set the appropriate directory permissions. If in doubt, chmod to 0777.',
...
'FluxBB has been installed'		=>	'EveBB has been installed. To finalize the installation please follow the instructions below.',
'Final instructions'			=>	'Final instructions',
'Info 17'						=>	'To finalize the installation, you need to click on the button below to download a file called config.php. You then need to upload this file to the root directory of your EveBB installation.',
...
'Evebb_admin_api_id' => 'API User ID',
'Evebb_admin_api_key' => 'API Key',
