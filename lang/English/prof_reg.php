...
//EvE-BB stuffs
'Bad API Key' 				=> 'The API Key must be a correctly formatted EvE Online API Key, please see <a href="http://www.eve-online.com/api" target="_blank">EvE Online.com</a> for more details.',
'Bad User ID' 				=> 'The User ID must be a correctly formatted EvE Online User ID, please see <a href="http://www.eve-online.com/api" target="_blank">EvE Online.com</a> for more details.',
'Bad Character ID' 		=> 'The Character ID must be a correctly formatted EvE Online Character ID, please see <a href="http://www.eve-online.com/api" target="_blank">EvE Online.com</a> for more details.',
'Dupe API' 					=> 'The API details you entered are already a part of the database.',
'Bad Character' 			=> 'The character you select must be in an allowed corporation.<br />If you feel this is in error, please try again in a few minutes and verify that the API server is up and running.',
'Bad Api Request' 			=> 'An error has occured while fetching your API information, please verify your information and the status of the EvE API server, then try again.',
//EvE-BB stuffs
